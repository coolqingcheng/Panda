...
namespace QingCheng.Site.Migrations
{
    ...
    [Migration("20230218115836_update202302181958")]
    partial class update202302181958
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QingCheng.Site.Data.Blogs.PostCateRelation", b =>
                {
                    ...
                    b.HasIndex("PostId")
                        .HasDatabaseName("ix_post_cate_relations_post_id");
            ...
            modelBuilder.Entity("QingCheng.Site.Data.Blogs.PostTagRelation", b =>
                {
                    ...
                    b.HasIndex("PostId")
                        .HasDatabaseName("ix_post_tag_relations_post_id");
            ...
            modelBuilder.Entity("QingCheng.Site.Data.Blogs.PostCateRelation", b =>
                {
                    ...
                    b.HasOne("QingCheng.Site.Data.Blogs.Posts", "Post")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_post_cate_relations_posts_post_id");
            ...
            modelBuilder.Entity("QingCheng.Site.Data.Blogs.PostTagRelation", b =>
                {
                    b.HasOne("QingCheng.Site.Data.Blogs.Posts", "Post")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_tag_relations_posts_post_id");
