...
namespace Panda.Site.Migrations
{
    ...
    [Migration("20220713151341_update20220713")]
    partial class update20220713
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.PostCommentRead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.Roles", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.SiteVisitors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.SysPermissions", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.PostCommentRead", b =>
                {
                    b.HasOne("Panda.Tools.Auth.Models.Accounts", "Accounts")
                        .WithMany()
                        .HasForeignKey("AccountsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Panda.Entity.DataModels.PostComments", "Comments")
                        .WithMany("CommentReads")
            ...
            modelBuilder.Entity("Panda.Entity.DataModels.SysPermissions", b =>
                {
                    ...
                    b.HasOne("Panda.Entity.DataModels.Roles", "Role")
                        .WithMany()
